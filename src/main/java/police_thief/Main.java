...
public class Main {
    public static void main(String[] args) {
        ...
        polices.add(new Police(1, thieves, 0, 0, 0, 10, 0, 10));      // 좌상
        polices.add(new Police(2, thieves, 11, 0, 11, 20, 0, 10));    // 우상
        polices.add(new Police(3, thieves, 0, 11, 0, 10, 11, 20));    // 좌하
        polices.add(new Police(4, thieves, 11, 11, 11, 20, 11, 20));  // 우하
